# =========================================
# 🌍 FLOOD RISK PROJECT - STREAMLIT APPS (SEPARATED CELLS)
# =========================================

# ==========================================================
# 🟢 APP 1: REGRESSION (FLOOD RISK SCORE)
...
# CELL 5: UI INPUTS
# -----------------------------
st.title("🌍 Flood Risk Score Prediction")
...
if st.button("Predict Score"):
    ...
    st.metric("Flood Risk Score", round(score,2))
